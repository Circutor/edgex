...
func (bpw boltProvisionWatcher) MarshalJSON() ([]byte, error) {
	...
	return json.Marshal(&struct {
		...
		ServiceID:      bpw.Service.Id.Hex(),
		ProfileID:      bpw.Profile.Id.Hex(),
	})
}
...
func (bpw *boltProvisionWatcher) UnmarshalJSON(data []byte) error {
	...
	err = b.GetDeviceServiceById(&ds, decoded.ServiceID)
	if err != nil {
		return err
	}

	var dp models.DeviceProfile
	err = b.GetDeviceProfileById(&dp, decoded.ProfileID)
	if err != nil {
		return err
	}
