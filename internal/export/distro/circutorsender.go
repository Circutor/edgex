...
type myCircutorSender struct {
	client MQTT.Client
	topic  string
}

// newMyCircutorSender - create new myCircutor mqtt sender
func newMyCircutorSender(addr contract.Addressable) sender {

	opts := MQTT.NewClientOptions()
	broker := "wss://" + addr.Address + ":" + strconv.Itoa(addr.Port) + addr.Path
